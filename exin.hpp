...
#pragma pack(pop)
	...
	struct ExEditInternal
	{
		...
		//
		template <typename T>
		inline static void assign(T& p, addr_t address)
		{
			p = (T)address;
		}
		...
		BOOL init()
		{
			...
			assign(address.variable.aviutl_window, exedit + 0x00135C6C);
			assign(address.variable.exedit_window, exedit + 0x00177A44);
			assign(address.variable.setting_dialog, exedit + 0x001539C8);
			assign(address.variable.object_table, exedit + 0x001E0FA4);
			assign(address.variable.sorted_object_table, exedit + 0x00168FA8);
			assign(address.variable.filter_table, exedit + 0x00187C98);
			assign(address.variable.current_scene_index, exedit + 0x001A5310);
			assign(address.variable.current_object_index, exedit + 0x00177A10);
			assign(address.variable.current_filter_index, exedit + 0x0014965C);
			assign(address.variable.object_count, exedit + 0x00146250);
			assign(address.variable.sorted_object_count, exedit + 0x0015918C);
			assign(address.variable.exdata_table, exedit + 0x001E0FA8);
			assign(address.variable.next_object_table, exedit + 0x001592d8);
			assign(address.variable.object_slection_table, exedit + 0x00179230);
			assign(address.variable.object_selection_count, exedit + 0x00167D88);
			assign(address.variable.scene_setting_table, exedit + 0x00177A50);
			assign(address.variable.editp, exedit + 0x001A532C);
			assign(address.variable.layer_width, exedit + 0x001A52FC);
			assign(address.variable.layer_height, exedit + 0x000A3E20);
			assign(address.variable.layer_visible_count, exedit + 0x000A3FBC);
			assign(address.variable.layer_setting_table, exedit + 0x000A4058);
			assign(address.variable.aviutl_frame_number, exedit + 0x0014D3A0);
			assign(address.variable.exedit_frame_number, exedit + 0x001A5318);
			assign(address.variable.exedit_current_frame, exedit + 0x001A5304);
			assign(address.variable.setting_dialog_menus[0], exedit + 0x00158D20); // 映像フィルタオブジェクト
			assign(address.variable.setting_dialog_menus[1], exedit + 0x00158D24); // 音声メディアオブジェクト
			assign(address.variable.setting_dialog_menus[2], exedit + 0x00158D2C); // 映像メディアオブジェクト＆グループ制御
			assign(address.variable.setting_dialog_menus[3], exedit + 0x00167D40); // カメラ制御＆時間制御
			assign(address.variable.setting_dialog_menus[4], exedit + 0x00167D44); // 音声フィルタオブジェクト
			assign(address.variable.selection_visual_count, exedit + 0x0017921C);
			assign(address.variable.selection_visual, exedit + 0x00146270 + 0x04);
			assign(address.variable.font_combobox, exedit + 0x0023630C);
			assign(address.variable.bpm, exedit + 0x00159190);

			assign(address.function.show_color_dialog, exedit + 0x0004D2A0);
			assign(address.function.frame_to_x, exedit + 0x00032BD0);
			assign(address.function.push_undo, exedit + 0x0008D150);
			assign(address.function.create_undo, exedit + 0x0008D290);
			assign(address.function.hide_controls, exedit + 0x00030500);
			assign(address.function.show_controls, exedit + 0x000305E0);
			assign(address.function.erase_filter, exedit + 0x00033D20);
			assign(address.function.swap_filter, exedit + 0x00033B30);
			assign(address.function.unknown1, exedit + 0x00034FF0);
			assign(address.function.get_alias_file_name, exedit + 0x00043FD0);
			assign(address.function.add_alias, exedit + 0x00029DC0);
			assign(address.function.save_filter_alias, exedit + 0x00028CA0);
			assign(address.function.load_exo, exedit + 0x0004DCA0);
			assign(address.function.save_exo, exedit + 0x000284D0);
			assign(address.function.set_scene, exedit + 0x0002BA60);
			assign(address.function.draw_item, exedit + 0x00037060);
			assign(address.function.redraw_setting_dialog, exedit + 0x00039490);
			assign(address.function.redraw_layer, exedit + 0x00039290);
			assign(address.function.redraw_layers, exedit + 0x000392F0);
			assign(address.function.erase_midpt, exedit + 0x00034A30);
			assign(address.function.update_object_table, exedit + 0x0002B0F0);
